    ...
    return (
        <div className="bg-[#50d2fe]   w-full overflow-hidden  ">
            ...
            <div className=' relative h-screen  w-full '>
                <img src="images/bg04.png" alt="background" className=" w-full  h-full absolute    z-0 object-cover" draggable='false'
                    loading="lazy" />
                {/* tree */}
                <div className=' mt-28 sm:mt-20 md:mt-8 lg:-mt-28 xl:-mt-48  absolute  w-40 lg:h-auto lg:w-auto '>
                    <img src='images/tree.png' className=' ' draggable='false'
                        loading="lazy" />
                    <div className='flex -ml-8 -mt-28'>
                        <img src='images/grass  2.png' className='  w-20 h-20 sm:w-auto sm:h-auto mt-10' draggable='false'
                            loading="lazy" />
                        <img src='images/grass 3.png' className='-ml-12 w-20 h-20 sm:w-auto sm:h-auto mt-10' draggable='false'
                            loading="lazy" />
                        <img src='images/grass  5.png' className='-ml-12 mt-16   w-20 h-20 sm:w-auto sm:h-auto ' draggable='false'
                            loading="lazy" />
                    </div>

                </div>
                {/* water leaf */}
                <img src='images/leaf01.png ' className='  z-10 top-[70%]  w-20 lg:w-auto lg:h-auto lg:top-[60%] left-[5%] relative ' draggable='false'
                    loading="lazy" />
                <img src='images/leaf01.png ' className='  z-10 w-28 top-[68%] left-[30%] relative ' draggable='false'
                    loading="lazy" />
                    ...
                    <div className=' w-[80%] md:w-[50%] lg:w-[40%]'>
                        ...
                        <div className="flex border backdrop-blur-lg  border-[#FFF3C5]  justify-between h-20 rounded-lg mt-10 shadow-lg">
                            ...
                            <div className=" h-full md:w-[35%] lg:w-[40%] relative rounded-r-lg flex items-center justify-center cursor-pointer hover:shadow-md hover:scale-95 transition duration-300">
                                ...
                                <img src='images/ButtonCustom.png' className='h-full my-auto w-full mt-[1px]   object-cover' draggable='false'
                                    loading="lazy" />
                ...
                <div
                    ...
                    <img src='images/Pose4.png' className='absolute sm:w-40 sm:mt-10 md:mt-28 w-32 md:w-56  lg:w-auto' draggable='false'
                        loading="lazy" />
                    <img src='images/haystack 2.png' className=' w-36 sm:w-48 md:w-64 lg:w-auto' draggable='false'
                        loading="lazy" />

                    <img src='images/pumpkin02.png ' className=' absolute mt-20 lg:w-36 right-0' draggable='false'
                        loading="lazy" />
                </div>
            </div>
        </div>
